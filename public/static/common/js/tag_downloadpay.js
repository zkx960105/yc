    ...
    ajax.onreadystatechange = function () {
        ...
        if (ajax.readyState==4 && ajax.status==200) {
            ...
            if (1 == res.code) {
                ...
                if (res.data.download_tips != '' && document.getElementById('download_tips_1655866225')) {
                    document.getElementById('download_tips_1655866225').style.display = "block";
                    document.getElementById('download_tips_1655866225').innerHTML = res.data.download_tips;
                }
            } else {
                if (!window.layer) {
                    alert(res.msg);
