<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:37:"./template/mobile/lists_single_ys.htm";i:1689988329;}*/ ?>
...
<body style="background-color:#f5f5f5;">
	<div class="rightBar">
		<div class="zx">
			<img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_m"); echo $__VALUE__; ?>/skin/img/mc.png" alt="...">
		</div>
		<div class="font">在线咨询</div>
	</div>
	<div class="no" style="padding-bottom: 46px;">
		<div class="header">
		...
		<script type="text/javascript">
			$('.rightBar .font').on('click', function () {
				window.location.href = 'http://p.qiao.baidu.com/cps/chat?siteId=14981026&userId=29479597';
			})
			$('.rightBar .zx').on('click', function () {
				window.location.href = 'http://wpa.qq.com/msgrd?v=3&uin=770935666&site=qq&menu=yes';
			})
		</script>
		<style type="text/css">
			.rightBar .zx {
				...
				background-image: linear-gradient(0deg,
						#f5f5f5 0%,
						#ffffff 100%);
				border-radius: 0.04rem 0px 0px 0px;
				position: fixed;
				right: 0;
				top: 10.36rem;
				z-index: 9999;
		...
		<div class="advtange">
			...
			<div class="adv-title">
				<div class="advt01">Ten Advantages</div>
				<div class="advt02">十大优势</div>
			</div>
		...
		<div class="fcon">
			...
			<p>400-8765-801</p>
			<p>Copyright@艾艺荷马</p>
			<p>备案号： <a href="https://beian.miit.gov.cn/#/Integrated/index"> 渝ICP备16006556号-4</a></p>
		</div>
	</div>
	...
	<div class="modal" style="">
		<form action="http://www.ayhmjy.com/home/index/message1" enctype="multipart/form-data" method="post"
			...
			<div class="content">
				...
				<div class="inputwrapper">
					<div class="right">
						<input type="text" placeholder="验证码" style="width: 50%" name="code" class="code"><img
							src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_m"); echo $__VALUE__; ?>/skin/img/checkverify.html"
							onclick="javascript:this.src=&#39;/home/type/checkverify.html?tm=&#39;+Math.random();">
						<div class="cha chaq"></div>
					</div>
				</div>
