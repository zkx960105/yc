<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:34:"./template/pc/lists_article_td.htm";i:1689955539;s:40:"/data/user/htdocs/template/pc/header.htm";i:1689869392;s:40:"/data/user/htdocs/template/pc/footer.htm";i:1689869391;}*/ ?>
<!DOCTYPE html>
		...
		<div class="warpper">
			...
			<div class="youxiucom">
				<div class="activeclidk rigleft">
					...
					<span class="<?php echo $field['currentclass']; ?>"><a href="<?php echo $field['typeurl']; ?>"><?php echo $field['typename']; ?></a></span>
					<?php ++$e; endforeach; endif; else: echo htmlspecialchars_decode("");endif; $field = []; ?>
				</div>
				<ul class="showlist tdlist" style="display: flex;flex-wrap: wrap;">
					...
					<li>
						...
						<p class="national_titi" style="padding-top:30px;">
							...
							<span class="nation_right">
								...
								<label><?php echo $field['zhiwei']; ?></label>
							</span>
						</p>
