<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:44:"./application/admin/template/index/index.htm";i:1689865663;s:65:"/data/user/htdocs/application/admin/template/public/theme_css.htm";i:1689865671;s:63:"/data/user/htdocs/application/admin/template/public/menubox.htm";i:1689865671;s:60:"/data/user/htdocs/application/admin/template/public/left.htm";i:1689865671;}*/ ?>
<!doctype html>
<html>
<head>
              ...
              <em class="eyou_tool em_authortoken" data-expanded="close">
                ...
                <ul class="dropdown-menu" role="menu" aria-labelledby="shouquan">
                    ...
                    <li class="ey-tool-list text-center">
                      <input class="btn btn-primary" type="button" onclick="$('.em_authortoken').toggleClass('open');openItem('Index|authortoken');" value="购买后校验" />
                    </li>
                </ul>
               </em>
              <!-- 商业授权 -->
