<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:38:"./template/mobile/lists_article_td.htm";i:1689988884;}*/ ?>
<!DOCTYPE html>
...
<body>
	...
	<div class="no" style="padding-bottom: 50px;">
		...
		<div class="nbanner">
			...
			<img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_m"); echo $__VALUE__; ?>/skin/img/bszll.jpg">
		...
		<div class="mbg" style="min-height: 593px;">
				...
				<ul>
					...
					<li><a>
							...
							<div class="txt">
								...
								<div class="title over1"><?php echo $field['title']; ?></div>

								<div class="desc over1"><?php echo $field['zhiwei']; ?></div>
