<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:34:"./template/mobile/view_article.htm";i:1690011535;s:44:"/data/user/htdocs/template/mobile/header.htm";i:1690009784;s:44:"/data/user/htdocs/template/mobile/footer.htm";i:1689993214;}*/ ?>
<!DOCTYPE html>
...
<body>
    ...
    <div class="logo2"><a><img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_m"); echo $__VALUE__; ?>/skin/img/logo2.png"></a></div>
		...
		<div class="nbanner">
			<img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_m"); echo $__VALUE__; ?>/skin/img/article_page_banner.jpg">
		</div>

		<div class="mbg" style="min-height: 392px;">
